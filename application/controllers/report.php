...
class Report extends CI_Controller {
        ...
        $objPHPExcel = new PHPExcel();
                $objPHPExcel->getProperties()->setTitle("Laporan Rencana My Planizer");
                $objPHPExcel->getProperties()->setDescription("Berisi data rencana (Kode rencana, Nama rencana, deskripsi rencana, dan status.");
        $objPHPExcel->setActiveSheetIndex(0);

        // Header laporan
        $objPHPExcel->getActiveSheet()->setCellValue('A1','Laporan Rencana My Planizer');
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5','Kode Rencana');
        $objPHPExcel->getActiveSheet()->setCellValue('B5','Nama Rencana');
        ...
        $filename='Laporan_Rencana_'.$today.'.xlsx';
