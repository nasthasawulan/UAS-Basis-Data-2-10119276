...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#ajax_add_item").load("<?php echo base_url('newitem/lihat_item_paging');?>");

        // melakukan proses tambah item ketika tombol ditekan
        $('#form-insert-item').submit(function(){
            $.ajax({
                type:'POST',
                url:"<?php echo base_url('newitem/proses_item') ?>",
                data:$(this).serialize(),
        ...
        $("#ajax_add_item").on("click", ".btn-edit", function() {
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo base_url('newitem/show_item') ?>",
                data:{ kode: kode },
                dataType: 'JSON',
                success:function (data) {
                    if(data.item) {
    ...
    $('#input-kode').keyup(function(){
        ...
        $.ajax({
            type:"POST",
            url:"<?php echo base_url('newitem/proses_cari_item');?>",
            data:'nip='+nip,
