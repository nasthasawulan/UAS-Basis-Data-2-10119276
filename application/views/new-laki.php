...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#ajax_add_item").load("<?php echo base_url('newlaki/lihat_item_paging');?>");

        // melakukan proses tambah item ketika tombol ditekan
        $('#form-insert-item').submit(function(){
            $.ajax({
                type:'POST',
                url:"<?php echo base_url('newlaki/proses_item') ?>",
                data:$(this).serialize(),
        ...
        $("#ajax_add_item").on("click", ".btn-edit", function() {
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo base_url('newlaki/show_item') ?>",
                data:{ kode: kode },
                dataType: 'JSON',
                success:function (data) {
                    if(data.item) {
    ...
    $('#input-kode').keyup(function(){
        ...
        $.ajax({
            type:"POST",
            url:"<?php echo base_url('newlaki/proses_cari_item');?>",
            data:'nip='+nip,
