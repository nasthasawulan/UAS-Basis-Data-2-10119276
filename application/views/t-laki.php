                ...
                <tbody>
                    ...
                    <?php foreach ($daftar_item as $item) {?>
                        <tr>
                            ...
                            <td width="50"><a href="<?php echo base_url('newlaki/delete_item/'.$item->nip);?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin untuk menghapus data ini?');"><span class="glyphicon glyphicon-trash"></span></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>                                 
